<?php
	 ...
	 * list a collection of DatoString objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this DatoStringListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class DatoStringListPanel extends DatoStringListPanelGen {
