...
class DocenteMiniDataGridGen extends DocenteDataGrid {
        ...
        protected function addColumns() {
            ...
            $this->AddColumn(new QDataGridColumn(QApplication::Translate("Docente"), '<?= $_CONTROL->item_Render($_ITEM) ?>', 'HtmlEntities=false'));

        }


        public function item_Render(Docente $objDocente) {

                $ctrItem = new DocenteItemPanel($this,$objDocente);
