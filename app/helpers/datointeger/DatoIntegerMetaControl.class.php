<?php
	 ...
	 * DatoInteger class.  This code-generated class extends from
	 * the generated MetaControl class, which contains all the basic elements to help a QPanel or QForm
	 * display an HTML form that can manipulate a single DatoInteger object.
	 *
	 ...
	 */
	class DatoIntegerMetaControl extends DatoIntegerMetaControlGen {
		...
		public function lblDatecreated_Create($strControlId = null, $strDateTimeFormat = null) {
			...
			if($this->blnEditMode){
				$this->lblDatecreated->Text = $this->DatoInteger->Datecreated->__toString(QDateTimeCustom::FormatApp);
