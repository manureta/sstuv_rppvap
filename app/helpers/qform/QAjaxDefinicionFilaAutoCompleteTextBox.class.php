<?php
	 ...
	 * @package Controls
	 */
	class QAjaxDefinicionFilaAutoCompleteTextBox extends QAjaxAutoCompleteTextBox {

                private $strSelectedValue;
                private $strSelectedText;
                private $objDefinicionFila;
			...
			$strReturn = sprintf('$("#%s").autocomplete("%s",
                ...
                protected function GetControlHtml() {
                    ...
                    $strReturn .= sprintf("<img src='%s/images/tilde_ok.gif' id='%s_tilde_ok' style='display:%s'/>
                                        ...
                                        __VIRTUAL_DIRECTORY__, $this->strControlId,(!is_null($this->objDefinicionFila))?'inline':'none',
			...
			switch ($strName) {
                ...
                public function __set($strName, $mixValue) {
                        ...
                        switch ($strName) {
                                ...
                                case "DefinicionFila":
                                        try {
                                                $this->objDefinicionFila = QType::Cast($mixValue, 'DefinicionFila');
                                                if($this->objDefinicionFila){
                                                    $this->strSelectedText = $this->strText = $this->objDefinicionFila->Nombre;
                                                    $this->strSelectedValue = $this->objDefinicionFila->IdDefinicionFila;
                                                }
                                                break;
