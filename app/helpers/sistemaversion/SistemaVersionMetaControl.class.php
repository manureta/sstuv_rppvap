<?php
	 ...
	 * SistemaVersion class.  This code-generated class extends from
	 * the generated MetaControl class, which contains all the basic elements to help a QPanel or QForm
	 * display an HTML form that can manipulate a single SistemaVersion object.
	 *
	 ...
	 */
	class SistemaVersionMetaControl extends SistemaVersionMetaControlGen {
		...
		public function lblDatecreated_Create($strControlId = null, $strDateTimeFormat = null) {
			...
			if($this->blnEditMode){
				$this->lblDatecreated->Text = $this->SistemaVersion->Datecreated->__toString(QDateTimeCustom::FormatApp);
