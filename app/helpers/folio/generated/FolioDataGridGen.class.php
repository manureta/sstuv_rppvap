...
class FolioDataGridGen extends QFilteredDataGrid {
    ...
    protected function addAllColumns() {
        ...
        if (FolioDataGrid::$strColumnsArray['CensoGrupoFamiliarAsId']) $this->MetaAddColumn(QQN::Folio()->CensoGrupoFamiliarAsId)->Title = QApplication::Translate('CensoGrupoFamiliarAsId');
...
/**
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'CensoGrupoFamiliarAsId': return QQN::Folio()->CensoGrupoFamiliarAsId;
