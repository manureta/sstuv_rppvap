...
class FolioDataGridGen extends QFilteredDataGrid {
    ...
    public static $strColumnsArray = array(
        ...
        'ConflictoHabitacionalAsId' => true,
    ...
    protected function addAllColumns() {
        ...
        if (FolioDataGrid::$strColumnsArray['ConflictoHabitacionalAsId']) $this->MetaAddColumn(QQN::Folio()->ConflictoHabitacionalAsId)->Title = QApplication::Translate('ConflictoHabitacionalAsId');
...
/**
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'ConflictoHabitacionalAsId': return QQN::Folio()->ConflictoHabitacionalAsId;
