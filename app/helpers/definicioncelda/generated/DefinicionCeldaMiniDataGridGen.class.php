...
class DefinicionCeldaMiniDataGridGen extends DefinicionCeldaDataGrid {
        ...
        protected function addColumns() {
            ...
            $this->AddColumn(new QDataGridColumn(QApplication::Translate("DefinicionCelda"), '<?= $_CONTROL->item_Render($_ITEM) ?>', 'HtmlEntities=false'));

        }


        public function item_Render(DefinicionCelda $objDefinicionCelda) {

                $ctrItem = new DefinicionCeldaItemPanel($this,$objDefinicionCelda);
