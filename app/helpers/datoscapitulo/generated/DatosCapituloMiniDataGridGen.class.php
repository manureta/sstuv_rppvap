...
class DatosCapituloMiniDataGridGen extends DatosCapituloDataGrid {
        ...
        protected function addColumns() {
            ...
            $this->AddColumn(new QDataGridColumn(QApplication::Translate("DatosCapitulo"), '<?= $_CONTROL->item_Render($_ITEM) ?>', 'HtmlEntities=false'));

        }


        public function item_Render(DatosCapitulo $objDatosCapitulo) {

                $ctrItem = new DatosCapituloItemPanel($this,$objDatosCapitulo);
