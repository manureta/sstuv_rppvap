...
class UsuarioMiniDataGridGen extends UsuarioDataGrid {
        ...
        protected function addColumns() {
            ...
            $this->AddColumn(new QDataGridColumn(QApplication::Translate("Usuario"), '<?= $_CONTROL->item_Render($_ITEM) ?>', 'HtmlEntities=false'));

        }


        public function item_Render(Usuario $objUsuario) {

                $ctrItem = new UsuarioItemPanel($this,$objUsuario);
