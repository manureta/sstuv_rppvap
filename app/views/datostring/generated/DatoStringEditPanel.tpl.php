<?php
	// This is the HTML template include file (.tpl.php) for dato_stringEditPanel.
	// Remember that this is a DRAFT.  It is MEANT to be altered/modified.
	// Be sure to move this out of the drafts/dashboard subdirectory before modifying to ensure that subsequent
	// code re-generations do not overwrite your changes.
?>
	<div id="formControls">
		<?php $_CONTROL->lblIdDatoString->RenderWithName(); ?>
		<?php $_CONTROL->lstIdCampoObject->RenderWithName(); ?>
		<?php $_CONTROL->lstIdPersonalObject->RenderWithName(); ?>
		<?php $_CONTROL->txtIdDesignacion->RenderWithName(); ?>
