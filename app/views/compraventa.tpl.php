...
<p lang="es-Es" align="center">
    <strong>BARRIO <?=strtoupper($this->objHogar->IdFolioObject->NombreBarrioOficial);?> </strong>
</p>
<p align="center">
...
CIRC. <strong><?=$this->objHogar->Circ;?></strong>,
...
<p lang="es-ES">
    ...
    presente, el inmueble identificado en el encabezamiento de este Boleto.
</p>
<p lang="es-ES">
    La venta del inmueble se formaliza en el estado y en las condiciones en que se encuentra a la fecha del presente que “EL COMPRADOR” declara conocer y
    aceptar y sin reserva alguna con renuncia expresa a interponer cualquier acción presente o futura contra “EL INSTITUTO” y/o “PROVINCIA DE BUENOS AIRES”,
    por cualquier causa o motivo quedando a su exclusivo cargo los gastos que por cualquier concepto pudieran originarse en lo sucesivo, tomando posesión del
...
<p lang="es-ES">
    <strong>SEXTA</strong>
    : El primer servicio de amortización deberá ser abonado inmediatamente una vez recibida la tarjeta de pago oportunamente cursada por “LA SUBSECRETARIA” y
    recibida de conformidad por “EL COMPRADOR”.
</p>
<p lang="es-ES">
    Los servicios mensuales restantes con más los cargos, que en su caso correspondan de conformidad con lo establecido en este BOLETO, serán satisfechos por
    “EL COMPRADOR” en forma ininterrumpida, entre los días PRIMERO (1) y DIEZ (10) de cada uno de los meses inmediatos siguientes al fijado para el pago del
    primero de los servicios de amortización.
</p>
<p lang="es-ES">
    Los pagos se acreditarán mediante depósito a efectuar por “EL COMPRADOR” para la cuenta fiscal N° 1397 denominada “Recaudación por cuenta de Terceros”
    abierta en el Banco de la Provincia de Buenos Aires, Casa Matriz –La Plata.
</p>
<p lang="es-ES">
...
<p lang="es-ES">
    ...
    La mora en el pago de los servicios de amortización dentro del plazo y en la forma prevista en el plan de financiación acordado para la cancelación del
...
<p lang="es-ES">
    ...
    La deuda que resulta de la financiación que se conviene en la cláusula SEGUNDA o el saldo de la misma a la fecha de la extensión de la escritura traslativa
    de dominio sobre el inmueble objeto de la operación podrá ser garantizada mediante la constitución de derecho real de hipoteca a favor de “EL INSTITUTO” a constituirse en ese acto.
</p>
</page>
<page size="A4">
<p lang="es-ES" align="center">
...
<p lang="es-ES">
    La falta de pago de tres servicios de amortización consecutivos o como máximo cinco alternados por año calendario hará exigible el saldo total adeudado,
    sin necesidad de interpelación judicial o extrajudicial alguna. En el supuesto en que la mora del deudor se produjera antes de otorgarse la escritura
    traslativa de dominio, “EL INSTITUTO” podrá optar entre exigir el pago del saldo total adeudado dentro de un plazo perentorio e impostergable que no
    excederá de TREINTA (30) días corridos o bien declarar la rescisión del boleto, con perdida para el comprador de todas las sumas abonadas, que quedarán a
    favor de “ EL INSTITUTO” en concepto de indemnización por el uso del bien sin perjuicio de exigir desde entonces el reintegro de la posesión del inmueble.
    Se considerarán los importes actualizados que hubieran abonado como el pago por el uso del inmueble el que se determinará conforme al valor locativo del
    mismo al momento de su rescisión. En el supuesto de resultar saldo a favor del comprador una vez deducidos los rubros indicados, deberá “EL INSTITUTO”,
    devolverlo actualizado al comprador; caso contrario, de existir deuda a favor de “EL INSTITUTO”, éste podrá exigir su cobro judicialmente.
</p>
<p lang="es-ES">
    El pacto comisorio por falta de pago no podrá hacerse valer después que el adquirente haya abonado el 25% del precio actualizado, o haya realizado
    construcciones equivalentes al 50% del precio de compra, ambas actualizadas.
</p>
<p lang="es-ES">
...
<p lang="es-ES">
    ...
    En la cancelación anticipada de la deuda, el saldo se determinará multiplicando el número de cuotas faltantes por el valor de ésta según el último
    vencimiento. De igual modo, cuando los adjudicatarios desearen anticipar pagos de cuotas, los importes respectivos se aplicarán de acuerdo al párrafo
    anterior.
</p>
<p lang="es-ES">
...
<p lang="es-ES">
    ...
    : Toda transgresión a las normas establecidas por “El INSTITUTO”, “LA SUBSECRETARIA” y/o “EL PROGRAMA”, para la adjudicación de inmuebles facultará al
    “INSTITUTO” a dar por rescindido el presente boleto de pleno derecho y sin necesidad de interpelación judicial o extrajudicial alguna, debiendo procederse
    a su inmediato desalojo sean quienes fueren sus ocupantes salvo si están cumplidos los porcentajes de la cláusula octava.
</p>
<p lang="es-ES">
...
<p lang="es-ES">
    ...
    : El beneficiario no podrá transmitir el bien gravado, enajenar, dar en uso, usufructo, comodato, locación, la unidad objeto de este contrato sin haber
    saldado su obligación hipotecaria.
</p>
<p lang="es-ES">
...
<p lang="es-ES">
    ...
    : En caso de que se acreditare que “EL COMPRADOR” y/o cualquier miembro de su grupo familiar a cargo tuviere algún otro bien inmueble inscripto a su nombre
    y/o fuere beneficiario de algún programa nacional o provincial que le permita el acceso a una vivienda, hasta la cancelación definitiva de la deuda, se
    rescindirá la presente operación de pleno derecho sin necesidad de interpelación judicial, para lo cual se le notificará al interesado en forma fehaciente.
    -
</p>
<p lang="es-ES">
