	...
	<page size="A4">
		<div class="cont">
			...
			<input value="Nro. de expropiación" style="margin-left:215px;width:150px">
			<input value="Otros ¿Cuáles?" style="margin-left:20px;width:150px"></br>
			...
			<form id="sit_amb">
				...
				<input type="checkbox">
				<small>Obras de Infraestructura</small>
				<input type="checkbox">
				<small>Equipamientos</small>
				<input type="checkbox">
				<small>Otros ¿Cuáles?</small>
			</form>
			<input value="Otros ¿Cuáles?" style="margin-left:565px"></br>
