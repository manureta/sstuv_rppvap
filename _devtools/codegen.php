...
if (QApplication::$CliMode) {
    ...
    if (QApplication::QueryString("tabla")) {
        QCodeGenBase::$OnlyTable = QType::Cast(QApplication::QueryString("tabla"), QType::String);
    } else {
        QCodeGenBase::$OnlyTable = false;
    }
    /////////////////////////////////////////////////////
...
echo "Generation done.\nExcecution time: ".(time()-$start_time). "seconds\n";
