<?php
require_once('../../../app/prepend.inc.php');
...
<html>
	...
	<body style='margin:0 0 0 0;'>
		...
		<table border="0" cellspacing="0" width="100%">
			<tr>
				<td nowrap="nowrap" class="headingLeft"><span class="headingLeftSmall">Qcubed Development Framework <?= QCODO_VERSION ?><br /></span>Database Profiling Tool</td>
