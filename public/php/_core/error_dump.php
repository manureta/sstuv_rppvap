...
<html>
    ...
    <table border="0" cellspacing="0" width="100%">
        <tr>
            <td nowrap="nowrap" style="background-color: #440066; color: #ffffff; padding: 10px 0px 10px 10px; font-family: 'Verdana, Arial, Helvetica, sans-serif'; font-size: 18px; font-weight: bold; width: 70%; vertical-align: middle;" class="headingLeft"><span style="font-size: 10px;" class="headingLeftSmall"><?php _p($__exc_strType); ?> in PHP Script<br /></span><?php _p($_SERVER["PHP_SELF"]); ?></td>
            <td nowrap="nowrap" style="background-color: #440066; color: #ffffff; padding: 0px 10px 10px 10px; font-family: 'Verdana, Arial, Helvetica, sans-serif'; font-size: 10px; width: 30%; vertical-align: middle; text-align: right;" class="headingRight">
                ...
                <b>HTTP User Agent:</b> <?php _p(array_key_exists('HTTP_USER_AGENT', $_SERVER) ? $_SERVER['HTTP_USER_AGENT'] : ''); ?></td>
        </tr>
    </table>

    <div style="padding: 10px;" >
        <span style="font-family: 'Verdana, Arial, Helvetica, sans-serif'; font-size: 19px; font-style: italic; color: #330055;"><?php _p($__exc_strMessageBody, false); ?></span><br />
...
<?php
            if (isset($__exc_strRenderedPage)) {
                ...
                <a href="<?php _p(__VIRTUAL_DIRECTORY__ . __PHP_ASSETS__) ;?>/_core/error_already_rendered_page.php" target="_blank">
                    Click here</a> to view contents able to be rendered
                <br /><br />
<?php
            }
?>
            ...
            <div style="background-color: #f4eeff; padding: 1px 10px 1px 10px;" >
<?php
                        _p('<pre>', false);
                    ...
                    if ((strpos($__exc_Key, "__exc_") === false) && (strpos($__exc_Key, "_DATE_") === false) && ($__exc_Key != "GLOBALS") && !($__exc_ObjVariableArray[$__exc_Key] instanceof QForm)) {
                        try {
                            if (($__exc_Key == 'HTTP_SESSION_VARS') || ($__exc_Key == '_SESSION')) {
                                ...
                                $__exc_StrVarExport = htmlentities(print_r($__exc_ObjSessionVarArray, true));
                                ...
                                $__exc_StrVarExport = htmlentities(print_r($__exc_ObjVariableArray[$__exc_Key], true));
...
?>
            ...
            <hr width="100%" size="1" style="color:'#dddddd'" />
