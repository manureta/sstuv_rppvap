...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'soporte@cenpe.gob.ar';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Sistemas DiNIECE';
   ...
   * @var string
   */
  public $Sender            = 'soporte@cenpe.gob.ar';
  ...
  public function SmtpSend($header, $body) {
    ...
    $error = '';
    $bad_rcpt = array();
    LogHelper::Debug('Conectando al servidor SMTP: '.$this->smtp);
    if(!$this->SmtpConnect()) {
      return false;
    }
  ...
  function SetLanguage($lang_type = 'es', $lang_path = 'language/') {
	...
	if (file_exists($filename)) {
      ...
      $PHPMAILER_LANG["provide_address"]      = 'Debe indicar una dirección de email ' .
      $PHPMAILER_LANG["mailer_not_supported"] = ' mailer is not supported.';
      $PHPMAILER_LANG["execute"]              = 'No se pudo ejecutar: ';
      $PHPMAILER_LANG["instantiate"]          = 'No se pudo iniciar la función de mail.';
      $PHPMAILER_LANG["authenticate"]         = 'SMTP Error: No se puede autenticar.';
      $PHPMAILER_LANG["from_failed"]          = 'Las siguientes direcciones fallaron: ';
      $PHPMAILER_LANG["recipients_failed"]    = 'SMTP Error: Los siguientes destinatarios fallaron ' .
      $PHPMAILER_LANG["data_not_accepted"]    = 'SMTP Error: No se aceptaron los datos.';
      $PHPMAILER_LANG["connect_host"]         = 'SMTP Error: No se pudo conectar con el servidor SMTP.';
      $PHPMAILER_LANG["file_access"]          = 'No se puede acceder al archivo: ';
      $PHPMAILER_LANG["file_open"]            = 'Error de archivo: No se puede abrir al archivo: ';
      $PHPMAILER_LANG["encoding"]             = 'Encoding desconocido: ';
      $PHPMAILER_LANG["signing"]              = 'Error de firma: ';
    }
