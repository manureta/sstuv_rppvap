...
///////////////////////////////////////////////////
	...
	var qcodo = {
		...
		// Polling Processing
		////////////////////////////////////
			this.registerPollingProcessor = function(strControlId, intPollingInterval, strWaitIconControlId) {
				setTimeout("qc.processPolling('" + strControlId + "','" + strWaitIconControlId + "');", intPollingInterval);
			};

			this.processPolling = function(strControlId, strWaitIconControlId) {
				// Get Info Needed for the Control Proxy call
				var strFormId = document.getElementById("Qform__FormId").value;

				// Make the callback
				qc.pA(strFormId, strControlId, 'QClickEvent', strWaitIconControlId, strWaitIconControlId);
			};
...
//implementación prototype de Array.remove para sacar un elemento del array
