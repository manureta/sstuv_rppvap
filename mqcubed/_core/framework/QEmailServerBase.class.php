<?php
	 ...
	 */
	abstract class QEmailServerBase extends QBaseClass {
		/**
		 ...
		 */
		public static $SmtpUsername = 'soporte@cenpe.gob.ar';
...
//					}
	...
	QEmailServerBase::$OriginatingServerIp = QApplication::$ServerAddress;
	...
	class QEmailMessage extends QBaseClass {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'FromName': return $this->strFromName;
		...
		public function __set($strName, $mixValue) {
			try {
				switch ($strName) {
					...
					case 'FromName': return ($this->strFromName = QType::Cast($mixValue, QType::String));
