		...
		//-------------------------------------------------------------------
                ...
                */
                public function Add<%= $objManyToManyReferenceTable->ClassName %>(<%= $objManyToManyReferenceTable->ClassName %> $objItem){
                   //add to the collection and add me as a parent
                    ...
                    //$this->Associate<%= $objManyToManyReference->ObjectDescription %>($objItem);
                ...
                */
                public function Remove<%= $objManyToManyReferenceTable->ClassName %>(<%= $objManyToManyReferenceTable->ClassName %> $objItem){
                    ...
                    $this->obj<%= $objManyToManyReference->ObjectDescription%>Array = array_diff($arrToDelete,$this-><%= $objManyToManyReference->ObjectDescription%>Array);
                    //automatic persistence to de DB
                    $this->Unassociate<%= $objManyToManyReference->ObjectDescription %>($objItem);
