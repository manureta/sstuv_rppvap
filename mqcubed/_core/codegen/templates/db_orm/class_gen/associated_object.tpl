		...
		//-------------------------------------------------------------------
                ...
                */
                public function Remove<%=$objReverseReference->ObjectDescription %>(<%=$objReverseReferenceTable->ClassName %> $objItem){
                    ...
                    $arrAux = $this->obj<%=$objReverseReference->ObjectDescription%>Array;
                    $this->obj<%=$objReverseReference->ObjectDescription%>Array = array();
                    foreach ($arrAux as $obj) {
                        if ($obj !== $objItem) 
                            array_push($this->obj<%=$objReverseReference->ObjectDescription%>Array,$obj);
                    }
