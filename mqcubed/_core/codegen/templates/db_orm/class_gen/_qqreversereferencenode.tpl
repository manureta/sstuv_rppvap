<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __DATAGEN_CLASSES__ %>" TargetFileName="QQReverseReferenceNode<%= $objTable->ClassName %>.class.php"/>
<?php
