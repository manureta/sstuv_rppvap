        /**
         * Create and setup QListBox <%= $strControlId %> ES ACA?
        ...
        public function <%= $strControlId %>_Create($strControlId = null) {
            ...
            $this-><%= $strControlId %>->Name = QApplication::Translate('<%= $objReverseReference->ObjectPropertyName %>');
    ...
    <% if ($objReverseReference->NotNull) { %>
        ...
        public function <%= $strLabelId %>_Create($strControlId = null) {
            ...
            $this-><%= $strLabelId %>->Name = QApplication::Translate('<%= $objReverseReference->ObjectPropertyName %>');
