<?php
	...
	abstract class QMetaControlArgumentType {
        ...
        abstract class QQueryOperatorType {
            const Like = 'like';
        ...
        abstract class QControllerActionType {
            const EditAction = 'Edit';
            const ViewAction = 'View';
            const IndexAction = 'Index';
            const ListAction = 'List';
            const ViewresumenAction = 'Viewresumen';
            const RowAction = 'Row';
            const ItemAction = 'Item';
            const DataGridAction = 'DataGrid';
            const MetaControlAction = 'MetaControl';
            const MiniDatagridAction = 'MiniDataGrid';
            const AllAction = 'All';
        }

        abstract class QBlockedCauseType {
            const Upgrade = 1;
            const Backup = 2;
            const ErrorUnrecoverable = 3;
            const ExternalErrorUnrecoverable = 4;
            const WrongDatabaseVersion = 5;
        }
