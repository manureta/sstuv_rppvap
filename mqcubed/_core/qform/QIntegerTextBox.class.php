...
class QIntegerTextBox extends QTextBox {
    ...
    public function GetEndScript() {
        return parent::GetEndScript() . sprintf("$('#%s').attr('onblur','ValidateInteger(this, %d, %d);');", $this->ControlId, $this->intMinimum, $this->intMaximum) . sprintf("$('#%s').attr('onkeyup','MaskInteger(this, %d);');", $this->ControlId, $this->intMinimum);
    }
