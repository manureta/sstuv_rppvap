...
class QPostgreSqlDatabase extends QDatabaseBase {
    ...
    public function Connect() {
        ...
        $strServer = ($this->Server)?' host='.$this->Server:'';
        $strUsername = ($this->Username)?' user='.$this->Username:'';
        $strPassword = ($this->Password)?' password='.$this->Password:'';
        $strPort = ($this->Port)?' port='.$this->Port:'';

        // Connect to the Database Server
        $this->objPgSql = @pg_connect(sprintf('dbname=%s %s%s%s%s', $strName, $strServer, $strUsername, $strPassword, $strPort));
...
class QPostgreSqlDatabaseResult extends QDatabaseResultBase {
    ...
    public function FetchAll(){
        return pg_fetch_all($this->objPgSqlResult);
    }
    ...
    public function FetchAssoc() {
        return pg_fetch_array($this->objPgSqlResult, null, PGSQL_BOTH);
    }
        ...
        if (array_key_exists($strColumnName, $this->strColumnArray)) {
            ...
            switch ($strColumnType) {
                ...
                case QDatabaseFieldType::VarChar:
                    #TODO chequear que esto no rompa otros lugares
                    # agregado porque en el metodo QDatabaseBase::SqlVariable se le aplica un addslashes
